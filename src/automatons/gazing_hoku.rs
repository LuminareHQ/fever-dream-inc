...
static DISTANCE_FROM_ORIGIN: f32 = 3.5;
...
fn setup(
    ...
    commands
        ...
        .observe(update_interface_state::<Pointer<Over>>(Some(
            crate::data::IncomeSource::GazingHoku,
        )))
        .observe(click);
}

fn click(_: On<Pointer<Click>>, mut game_data: ResMut<GameData>) {
    game_data.purchase_source(crate::data::IncomeSource::GazingHoku);
}
...
fn update_based_on_owned(
    ...
    let quantity_owned =
        game_data.get_quantity_owned_by_source(crate::data::IncomeSource::GazingHoku);
    ...
    if quantity_owned != current_count {
        ...
        commands.spawn((
            ...
            SceneRoot(scene),
            Automaton {
                source: crate::data::IncomeSource::GazingHoku,
