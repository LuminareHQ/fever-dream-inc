...
static DISTANCE_FROM_ORIGIN: f32 = 4.0;
...
fn setup(
    ...
    commands
        ...
        .observe(update_interface_state::<Pointer<Over>>(Some(
            crate::data::IncomeSource::GapingDubine,
        )))
        .observe(click);
}

fn click(_: On<Pointer<Click>>, mut game_data: ResMut<GameData>) {
    game_data.purchase_source(crate::data::IncomeSource::GapingDubine);
}
...
fn update_based_on_owned(
    ...
    let quantity_owned =
        game_data.get_quantity_owned_by_source(crate::data::IncomeSource::GapingDubine);
    ...
    if quantity_owned != current_count {
        ...
        commands.spawn((
            ...
            SceneRoot(scene),
            Automaton {
                source: crate::data::IncomeSource::GapingDubine,
